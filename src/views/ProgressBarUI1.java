 ...
 * @author Theja
 */
public class ProgressBarUI1 extends javax.swing.JFrame {

    /**
     * Creates new form ProgressBarUI
     */
    public ProgressBarUI1() {
        initComponents();
                ...
                for(int i=0;i<=100;i++){
                    ...
                    if(i<10){
                        try {
                            ...
                            Logger.getLogger(ProgressBarUI1.class.getName()).log(Level.SEVERE, null, ex);
                        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProgressBarUI1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProgressBarUI1().setVisible(true);
            }
        });
    }
