 ...
 * @author User
 */
public class ViewCustomerDetailsUI extends javax.swing.JFrame {
  ...
  List<RowFilter<Object,Object>> filters = new ArrayList<RowFilter<Object,Object>>(4);
     ...
     public static void main(String args[]) throws IOException, ClassNotFoundException {
        ...
        ViewCustomerDetailsUI theGUI = new ViewCustomerDetailsUI();
        theGUI.setVisible(true);
    }
    
  public ViewCustomerDetailsUI() throws ClassNotFoundException, IOException {
        initComponents();
   ...
   private void loadCustomersTable(SetOfAccounts acc) throws IOException, ClassNotFoundException
  {
      data = new Vector<Vector<String>>();
      for(Account account:acc)
          {
            Vector v=new Vector();
            v.add(account.getAccountNo());
            v.add(account.getPassengerName());
        ...
        tblCustomer.setRowSorter(sorter_Customers);
        jScrollPane1.setViewportView(tblCustomer);
        tblCustomer.setAutoscrolls(true);
